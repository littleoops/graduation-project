...
CREATE TABLE `file` (
  ...
  `originUrl` varchar(255) NOT NULL DEFAULT '',
  `outputUrl` varchar(255) DEFAULT NULL,
  `taskId` int(11) NOT NULL,
  `status` tinyint(4) NOT NULL COMMENT '0: offline 1: online',
  `reporter` varchar(60) NOT NULL DEFAULT '',
  `auditor` varchar(60) NOT NULL DEFAULT '',
...
CREATE TABLE `task` (
  ...
  `workTime` varchar(60) NOT NULL DEFAULT '',
  `logAssort` varchar(255) NOT NULL DEFAULT '',
  `minDBH` int(11) NOT NULL,
  `maxDBH` int(11) NOT NULL,
...
CREATE TABLE `user` (
  ...
  `role` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0: 登陆用户 1:用户管理员 2:数据管理员',
...
CREATE TABLE `user_file` (
  ...
  `updatedTime` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_file` (`userId`,`fileId`)
...
-- Dump completed on 2019-05-20 23:56:12
